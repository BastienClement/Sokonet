...
public class Sokoban implements Game {
	...
	public Sokoban(AnsiDisplay display) {
		...
		defaultBindings.set(Key.W, performMovement("UP", Level::up));
		defaultBindings.set(Key.A, performMovement("LEFT", Level::left));
		defaultBindings.set(Key.S, performMovement("DOWN", Level::down));
		defaultBindings.set(Key.D, performMovement("RIGHT", Level::right));
